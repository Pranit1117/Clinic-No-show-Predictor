...
[data-testid="stSidebar"] { background: linear-gradient(180deg, #060E20 0%, #0A1628 100%) !important; border-right: 1px solid rgba(0,212,255,0.18) !important; }
[data-testid="stSidebar"] [data-testid="stRadio"] label,
[data-testid="stSidebar"] [data-testid="stRadio"] p,
[data-testid="stSidebar"] [data-testid="stRadio"] span,
[data-testid="stSidebar"] [data-baseweb="radio"] span,
[data-testid="stSidebar"] [role="radiogroup"] label { color: #D8E8FF !important; font-size: 0.88rem !important; font-weight: 500 !important; }
[data-testid="stSidebar"] [data-baseweb="radio"][aria-checked="true"] span { color: #00D4FF !important; font-weight: 600 !important; }

label, [data-testid="stWidgetLabel"] p, [data-testid="stWidgetLabel"] span { color: #D8E8FF !important; font-weight: 500 !important; }
[data-testid="stCaptionContainer"] p, .stCaption, small { color: #9BBAD6 !important; font-size: 0.72rem !important; font-weight: 600 !important; letter-spacing: 0.1em !important; text-transform: uppercase !important; }

[data-testid="stMetric"] { background: rgba(15,32,68,0.85) !important; border: 1px solid rgba(0,212,255,0.18) !important; border-radius: 16px !important; padding: 1.25rem 1.5rem !important; backdrop-filter: blur(20px) !important; transition: all 0.3s ease !important; }
[data-testid="stMetric"]:hover { border-color: #00D4FF !important; box-shadow: 0 0 30px rgba(0,212,255,0.15) !important; transform: translateY(-2px) !important; }
[data-testid="stMetricLabel"] p, [data-testid="stMetricLabel"] span { font-size: 0.72rem !important; font-weight: 700 !important; letter-spacing: 0.12em !important; text-transform: uppercase !important; color: #9BBAD6 !important; }
[data-testid="stMetricValue"], [data-testid="stMetricValue"] * { font-family: 'DM Serif Display', serif !important; font-size: 2rem !important; color: #FFFFFF !important; }
[data-testid="stMetricDelta"], [data-testid="stMetricDelta"] svg + div, [data-testid="stMetricDelta"] > div { font-size: 0.82rem !important; font-weight: 600 !important; opacity: 1 !important; }
...
.stButton > button { background: linear-gradient(135deg, #00D4FF 0%, #00A8CC 100%) !important; color: #040D1E !important; font-weight: 700 !important; font-size: 0.88rem !important; letter-spacing: 0.05em !important; border: none !important; border-radius: 10px !important; padding: 0.65rem 1.4rem !important; transition: all 0.25s ease !important; box-shadow: 0 4px 20px rgba(0,212,255,0.25) !important; }
.stButton > button:hover { transform: translateY(-2px) !important; box-shadow: 0 8px 30px rgba(0,212,255,0.4) !important; }

[data-testid="stNumberInput"] > div, [data-testid="stNumberInput"] input { background: #0D1E42 !important; border-color: rgba(0,212,255,0.25) !important; color: #F0F6FF !important; border-radius: 8px !important; min-height: 42px !important; font-size: 0.95rem !important; }
[data-testid="stNumberInput"] button { background: transparent !important; color: #D8E8FF !important; border-color: rgba(0,212,255,0.15) !important; }
.stTextInput input { background: #0D1E42 !important; border-color: rgba(0,212,255,0.25) !important; color: #F0F6FF !important; border-radius: 8px !important; min-height: 42px !important; }
[data-baseweb="select"] > div:first-child { background: #0D1E42 !important; border-color: rgba(0,212,255,0.25) !important; border-radius: 8px !important; min-height: 42px !important; }
[data-baseweb="select"] span, [data-baseweb="select"] div[class*="placeholder"], [data-baseweb="select"] div[class*="singleValue"], [data-baseweb="select"] * { color: #F0F6FF !important; }

[data-baseweb="popover"], [data-baseweb="popover"] > div, [data-baseweb="menu"], [data-baseweb="menu"] > div, ul[data-baseweb="menu"], [role="listbox"], [role="listbox"] > div { background: #0D1E42 !important; border: 1px solid rgba(0,212,255,0.25) !important; border-radius: 10px !important; box-shadow: 0 8px 32px rgba(0,0,0,0.6) !important; }
[data-baseweb="menu"] li, [data-baseweb="menu"] [role="option"], [role="option"], [role="listbox"] li { background: #0D1E42 !important; color: #F0F6FF !important; font-size: 0.88rem !important; }
[data-baseweb="menu"] li:hover, [data-baseweb="menu"] [role="option"]:hover, [role="option"]:hover { background: rgba(0,212,255,0.18) !important; color: #FFFFFF !important; }
[aria-selected="true"][role="option"], [data-baseweb="menu"] [aria-selected="true"] { background: rgba(0,212,255,0.12) !important; color: #00D4FF !important; }

[data-testid="stSlider"] p, [data-testid="stSlider"] label, [data-testid="stSlider"] span { color: #D8E8FF !important; }
[data-testid="stSlider"] [data-testid="stThumbValue"] { color: #00D4FF !important; font-weight: 700 !important; }
[data-testid="stCheckbox"] label, [data-testid="stCheckbox"] p, [data-testid="stCheckbox"] span { color: #D8E8FF !important; font-size: 0.88rem !important; }

[data-testid="stTabs"] [role="tab"] { background: transparent !important; color: #9BBAD6 !important; font-size: 0.84rem !important; font-weight: 500 !important; letter-spacing: 0.04em !important; border: none !important; transition: all 0.2s ease !important; }
[data-testid="stTabs"] [role="tab"][aria-selected="true"] { color: #00D4FF !important; font-weight: 700 !important; border-bottom: 2px solid #00D4FF !important; }
[data-testid="stTabs"] [role="tab"]:hover { color: #E0EEFF !important; }

[data-testid="stMultiSelect"] span, [data-testid="stMultiSelect"] div { color: #F0F6FF !important; }
[data-baseweb="tag"] { background: rgba(0,212,255,0.15) !important; }
[data-baseweb="tag"] span { color: #00D4FF !important; }

[data-testid="stDataFrame"] { border: 1px solid rgba(0,212,255,0.18) !important; border-radius: 12px !important; overflow: hidden !important; }
[data-testid="stDataFrame"] th { background: rgba(0,212,255,0.08) !important; color: #9BBAD6 !important; font-size: 0.72rem !important; font-weight: 700 !important; letter-spacing: 0.08em !important; text-transform: uppercase !important; }
[data-testid="stDataFrame"] td { color: #E0EEFF !important; font-size: 0.85rem !important; }

[data-testid="stAlert"] { border-radius: 12px !important; }
[data-testid="stAlert"] p, [data-testid="stAlert"] div, [data-testid="stAlert"] span { color: #F0F6FF !important; font-size: 0.88rem !important; }
div[data-testid="stAlert"][kind="info"]    { background: rgba(0,212,255,0.08) !important; border: 1px solid rgba(0,212,255,0.3) !important; }
div[data-testid="stAlert"][kind="error"]   { background: rgba(255,75,110,0.08) !important; border: 1px solid rgba(255,75,110,0.35) !important; }
div[data-testid="stAlert"][kind="success"] { background: rgba(0,229,160,0.08) !important; border: 1px solid rgba(0,229,160,0.3) !important; }

[data-testid="stFileUploadDropzone"] { background: rgba(15,32,68,0.85) !important; border: 2px dashed rgba(0,212,255,0.25) !important; border-radius: 16px !important; }
[data-testid="stFileUploadDropzone"] span, [data-testid="stFileUploadDropzone"] p { color: #9BBAD6 !important; }
...
# Each neighbourhood has a distinct true base no-show rate
NEIGH_BASE_RATES = {
    "JARDIM CAMBURI":    0.18,
    "ITARARÉ":           0.32,
    "CENTRO":            0.22,
...
# ── PLOTLY BASE LAYOUT ────────────────────────────────────────────────────────
# IMPORTANT: no 'colorway' key here.
# The original code had colorway=["#00D4FF",...] which Plotly applied to ALL
# Bar traces, silently overriding any marker.colorscale — making every bar cyan.
BASE_LAYOUT = dict(
...
def interp_neigh_color(val, cmin=0.15, cmax=0.55):
    """
    Manually interpolate green→orange→red for each neighbourhood bar.
    We do NOT use Plotly's colorscale here because BASE_LAYOUT removing colorway
    would still leave Plotly using its own default colorway on some versions.
    Pre-computing explicit hex values is the only fully reliable approach.
    """
    t = max(0.0, min(1.0, (val - cmin) / (cmax - cmin)))
    if t <= 0.5:
        r2 = t / 0.5
        r = int(0x00 + r2 * (0xFF - 0x00))
        g = int(0xE5 + r2 * (0xB3 - 0xE5))
        b = int(0xA0 + r2 * (0x47 - 0xA0))
    else:
        r2 = (t - 0.5) / 0.5
        r = 0xFF
        g = int(0xB3 + r2 * (0x4B - 0xB3))
        b = int(0x47 + r2 * (0x6E - 0x47))
    return f"#{r:02X}{g:02X}{b:02X}"


# ── DATA HELPERS ──────────────────────────────────────────────────────────────
def simulate_appointments(n=80):
    np.random.seed(42 + n)   # fixed seed: neighbourhood variance stays consistent
    records = []
    base = datetime.now()
    for i in range(n):
        ...
        neigh_bias = NEIGH_BASE_RATES[neigh] - 0.27   # offset centred on 0
        p = float(np.clip(
        ...
        records.append({
            ...
            "age":                 age,
            "gender":              np.random.choice(["F","M"], p=[0.62,0.38]),
            "neighbourhood":       neigh,
...
with st.sidebar:
    ...
    if "Simulate" in data_mode:
        ...
        clicked = st.button("↻  Generate New Batch", use_container_width=True)
        # Regenerate on: button click, first load, or stale DATA_VERSION
        if clicked or "df" not in st.session_state or st.session_state.get("data_version") != DATA_VERSION:
...
if "Overview" in page:
    ...
    with col_a:
        ...
        fig_d.add_annotation(
            ...
            font=dict(color=RISK_COLORS[dominant_tier], size=16, family="DM Serif Display")
        )
        fig_d.update_layout(**layout(height=270, showlegend=True,
                             legend=dict(orientation="h",yanchor="bottom",y=-0.15,xanchor="center",x=0.5)))
        st.plotly_chart(fig_d, use_container_width=True, config={"displayModeBar":False})

    # ── SORTED PROBABILITY BAR ────────────────────────────────────────────────
    with col_b:
        ...
        fig_b = go.Figure(go.Bar(
            x=list(range(len(dfs))),          # plain list — pandas Index serializes as binary dict in newer Plotly
            y=dfs["no_show_prob"].tolist(),   # plain list — same issue with pandas Series
            marker=dict(color=clrs, line=dict(width=0)),
            hovertemplate="<b>%{customdata[0]}</b><br>Risk: %{y:.1%} · %{customdata[1]}<extra></extra>",
            customdata=[[p, r] for p, r in zip(dfs["patient_id"], dfs["risk_tier"])],
        ))
        fig_b.add_hline(y=0.55, line_dash="dot", line_color="#FF4B6E",
                        annotation_text="High",   annotation_font_color="#FF4B6E", annotation_font_size=10)
        fig_b.add_hline(y=0.35, line_dash="dot", line_color="#FFB347",
                        annotation_text="Medium", annotation_font_color="#FFB347", annotation_font_size=10)
        fig_b.update_layout(**layout(height=270))
        style_axes(fig_b)
        fig_b.update_xaxes(showticklabels=False)
        fig_b.update_yaxes(tickformat=".0%", range=[0, min(1.0, float(dfs["no_show_prob"].max())*1.25)])
    ...
    with col_c:
        ...
        # Pre-compute explicit per-bar hex colors (green→orange→red).
        # Do NOT use Plotly colorscale here — Plotly's internal colorway key
        # in older/certain versions overrides marker.colorscale on Bar traces.
        bar_colors = [interp_neigh_color(v) for v in nd["no_show_prob"]]

        fig_n = go.Figure(go.Bar(
            x=nd["no_show_prob"].tolist(),
            y=nd["neighbourhood"].tolist(),
            orientation="h",
            marker=dict(color=bar_colors, line=dict(width=0)),
            hovertemplate="<b>%{y}</b><br>Avg Risk: %{x:.1%}<extra></extra>",
        ))
        fig_n.update_layout(**layout(height=340))
        style_axes(fig_n)
        fig_n.update_xaxes(tickformat=".0%", range=[0, float(nd["no_show_prob"].max())*1.25])
    ...
    with col_d:
        ...
        for tier, color in RISK_COLORS.items():
            ...
            jitter_x = (sub["lead_time_days"].astype(float) + rng.uniform(-1.2, 1.2, len(sub))).tolist()
            jitter_y = (sub["no_show_prob"]                 + rng.uniform(-0.01, 0.01, len(sub))).tolist()
            fig_l.add_trace(go.Scatter(
                ...
                customdata=sub["lead_time_days"].tolist(),
            ))

        fig_l.update_layout(**layout(height=340))
        style_axes(fig_l, xtitle="Lead Time (days)", ytitle="Probability")
        fig_l.update_yaxes(tickformat=".0%", range=[0, min(1.0, float(df["no_show_prob"].max())*1.25)])
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with col_result:
        ...
        if not run:
            ...
            row_d  = {"no_show_prob":p,"patient_noshow_rate":hist,"lead_time_days":lead,"sms_sent":sms,"risk_tier":tier}
            action = get_intervention(row_d)
            ...
            fig_drv = go.Figure(go.Bar(
                x=list(drivers.values()), y=list(drivers.keys()), orientation="h",
                marker=dict(color=["#FF4B6E" if v>0 else "#00E5A0" for v in drivers.values()],
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with p2:
        ...
        cnt = {
            "STABLE":   sum(s=="STABLE"   for s in statuses),
